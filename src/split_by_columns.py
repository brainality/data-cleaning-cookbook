...
def split_dataset_by_columns(csv_path, input_columns):
    ...
    if not invalid.empty:
        ...
        logging.info(" ✅ No rows found with multiple category columns filled")
    ...
    if total_rows == total_split_rows:
        logging.info("✅ Row count matched - split successful")
    else:
        logging.info("✅ Row count did not match - check for invalid rows")
